 ...
 * (see src/domains/memory/service/processor.ts), which runs periodically to extract
...
import { getMemoryExecuteWithTools } from '../providers/executor.js';
...
export async function executor(
  ...
  const executeWithTools = getMemoryExecuteWithTools();
