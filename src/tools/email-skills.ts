...
import { validateSkillDefinition } from '../services/email-watcher/skills.js';
import { syncNewEmails } from '../services/email-watcher/sync.js';
import { classifyEmails } from '../services/email-watcher/classifier.js';
...
export const testEmailSkill: ToolDefinition = {
  ...
  handler: async (input, context) => {
    ...
    try {
      ...
      const { listEmails } = await import('../services/google/gmail.js');
      ...
      const { prepareEmailForClassification } = await import('../services/email-watcher/sync.js');
      const { getEmail } = await import('../services/google/gmail.js');
      const { google } = await import('googleapis');
      const { getAuthenticatedClient } = await import('../services/google/auth.js');
