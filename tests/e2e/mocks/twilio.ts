/**
 * E2E mock for twilio module.
 *
 * Structurally identical to tests/mocks/twilio.ts.
 * Captures outbound messages for assertions without making real API calls.
 * Preserves real validateRequest and getExpectedTwilioSignature from the SDK.
 */
...
/**
 * Clear all sent messages. Call this in beforeEach or harness.reset().
 */
